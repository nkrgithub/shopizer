...
public class SecurityApiService implements SecurityApi {
    ...
    public ReadablePermissionResponse listPermissions(GroupNameRequest request) {
        ...
        List<com.salesmanager.shop.user.model.ReadablePermission> permissions = securityApi.listPermissions(group);
        return responsePermissions(permissions);
    }

    private ReadablePermission buildReadablePermission(com.salesmanager.shop.user.model.ReadablePermission permission) {
    ...
    public ReadablePermissionResponse permissions(EmptyRequest request) {
        List<com.salesmanager.shop.user.model.ReadablePermission> permissions = securityApi.permissions();
        return responsePermissions(permissions);
    }

    private ReadablePermissionResponse responsePermissions(List<com.salesmanager.shop.user.model.ReadablePermission> permissions) {
    ...
    public ReadableGroupResponse groups(EmptyRequest request) {
        List<com.salesmanager.shop.user.model.ReadableGroup> readableGroups = securityApi.groups();
    ...
    private ReadableGroup buildReadableGroup(com.salesmanager.shop.user.model.ReadableGroup group) {
