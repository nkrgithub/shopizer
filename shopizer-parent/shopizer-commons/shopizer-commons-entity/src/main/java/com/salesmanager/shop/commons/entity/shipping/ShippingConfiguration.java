...
public class ShippingConfiguration implements JSONAware {
	...
	private List<java.lang.Package> packages = new ArrayList<java.lang.Package>();
	...
	public String toJSONString() {
		...
		for(java.lang.Package p : this.getPackages()) {
	...
	@SuppressWarnings("unchecked")
	private JSONObject transformPackage(java.lang.Package p) {
		JSONObject data = new JSONObject();
