package com.salesmanager.shop.commons.entity.catalog.catalog;
...
@Entity
@EntityListeners(value = com.salesmanager.shop.commons.entity.common.audit.AuditListener.class)
